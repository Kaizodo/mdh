...
class ControllerCommonFooter extends Controller {
    public function index() {
        ...
        if ($this->config->get('theme_default_directory') == "opc_electronics_salora_2301") {
            ...
            $data['tvcmsstoretime_status']          = isset($store_time['tvcmsstoretime_status']) ? $store_time['tvcmsstoretime_status'] : "";
            $data['tvcmsstoretime_monday_friday']   = isset($store_time['tvcmsstoretime_monday_friday']) ? $store_time['tvcmsstoretime_monday_friday'] : "";
            $data['tvcmsstoretime_saterday']        = isset($store_time['tvcmsstoretime_saterday']) ? $store_time['tvcmsstoretime_saterday'] : "";
            $data['tvcmsstoretime_sunday']          = isset($store_time['tvcmsstoretime_sunday']) ? $store_time['tvcmsstoretime_sunday'] : "";
            $data['tvcmsstoretime_title']           = isset($store_time['tvcmsstoretime_title']) ? $store_time['tvcmsstoretime_title'] : "";
            $data['tvcmsstoretime_information']     = isset($store_time['tvcmsstoretime_information']) ? $store_time['tvcmsstoretime_information'] : "";
