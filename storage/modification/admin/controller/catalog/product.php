...
class ControllerCatalogProduct extends Controller {
  ...
  if($this->config->get('product_video_status')){
  $data['entry_product_video_url'] = $this->language->get('entry_product_url');
  $data['product_video_status']=$this->config->get('product_video_status');
  }
...
if (isset($this->request->post['product_video'])) {
      $data['product_video'] = $this->request->post['product_video'];
                        ...
                        if(isset($product_info['video'])){
      $data['product_video'] = $product_info['video'];
    }} else {
      $data['product_video'] = '';
    }
